...
| Caching    | Redis / in-memory via @nestjs/cache-manager          |
...
| Topic                                              | Skill                                        |
| -------------------------------------------------- | -------------------------------------------- |
| Controllers, services, DI, data flow, integrations | `/references/IntegrationLogic/SKILL.md`      |
| PostgreSQL, schema, migrations, queries, ORM       | `/references/Database-Postgres/SKILL.md`     |
| REST design, versioning, pagination, module layout | `/API-Architecture/SKILL.md`                 |
| DTOs, validation, pipes, input parsing             | `/references/Validation-DTOs/SKILL.md`       |
| Auth, JWT, guards, RBAC, refresh tokens            | `/references/Auth-AccessControl/SKILL.md`    |
| Unit / integration / e2e tests                     | `/references/Testing/SK/referencesILL.md`    |
| Caching, queues, background jobs, latency          | `/Performance-Queues-Caching/SKILL.md`       |
| Secrets, injection, cookies, hardening             | `/references/Security/SKILL.md`              |
| Logs, metrics, health, tracing                     | `/references/Observability/SKILL.md`         |
| Bugs, errors, stack traces, production issues      | `/references/Debugging/SKILL.md`             |
| PR review, quality, architecture assessment        | `/references/CodeReview/SKILL.md`            |
| Deploy, CI/CD, containers, env setup               | `/references/Deployment-Operations/SKILL.md` |
| Upgrades, refactors, ORM/framework migration       | `/references/Migration/SKILL.md`             |
| Docs, README, runbooks, Swagger, onboarding        | `/references/Documentation/SKILL.md`         |
| integrations , integration plans                   | `/references/Integration-Logic/SKILL.md`     |
